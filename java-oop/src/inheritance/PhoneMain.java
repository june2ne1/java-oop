...
class Iphone extends Celphone{
	private String data; //인스턴스 변수는 생성자 있어야함
	public static String BRAND = "아이폰"; //static 은 고정된 이란 의미로
	// static 이 붙은 변수는 상수역할 하는 변수 == 클래스변수
	...
	public void setData(String data,String name) { //오버로딩 =>캡슐화
		super.setCompany(BRAND);//애플은 여러 브랜드를 마들지 않고 무조건 아이폰이라고 한다
...
class Phone{
	...
	final static double TAX_RATE = 0.095; // 스태틱변수=>전역변수 =>스태틱영역
	...
	public void setCompany(String company) {
		this.company = company;//메소드 변수 =지역(의)변수 =>스택영역
	}
